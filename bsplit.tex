...
\begin{align}
\langle \phi_{20}| \Psi \rangle &=\langle 0 |\frac{1}{\sqrt{2}} \sigma_\textrm{z} \sigma_\textrm{z} | \Psi \rangle\\
\langle \phi_{20}| \Psi \rangle &=\langle 0 | \frac{1}{\sqrt{2}} \sigma_\textrm{z} \sigma_\textrm{z} 
...
\begin{multline}
\langle \phi_{20}| \Psi \rangle =\langle 0 | \frac{1}{\sqrt{2}} \left (  \sigma(0) e^{-\tau} + i\sqrt{2} e^{-\tau} \int^\tau_w d t' e^\tau E_\textrm{in}(t) \frac{g(t)}{\sqrt{\kappa}} \right )\\ \left ( \sigma(0) e^{-\tau} + i\sqrt{2} e^{-\tau} \int^\tau_w d t' e^\tau E_\textrm{in}(t) \frac{g(t)}{\sqrt{\kappa}} \right ) \sigma_\textrm{z}(t=0)^\dagger \int d\omega \psi(w) E_0^\dagger(w) | 0 \rangle
\end{multline}
